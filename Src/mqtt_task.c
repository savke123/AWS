	...
	while(1)
	{
		...
		if(mqttClient.isconnected)
		{
			...
			sprintf((char*)str,"{\n\"TempCelsius\" : %d, \n "
					...
					"\"MainBatCur[mA]\" : %s, \n "
					"\"NumOfChg\" : %d, \n "
					"\"Vreme\" : \"%d : %d : %d\" \n}", tempint,PorMppt.Pid,sw1.I1,sw2.I1,sw2.I2,sw3.I1,sw3.I2,sw4.I1,sw4.I2,sw5.I1,sw5.I2,sw6.I1,sw6.I2,PorMppt.Vpv,PorMppt.V,PorMppt.Il,PorMppt.Ppv,PorMppt.H21,PorMppt.H19,PorMppt.I,NOffCh,time.sat,time.min,time.sec);
...
int MqttConnectBroker()
{
	...
	xTaskCreate(StartT3Btn, "Task3Btn", 128, (void*)0, osPriorityNormal, &Task3BtnHandle);
